  ...
  const setTabState = (_tab: string) => {
    ...
    return (
      <div
        ...
        className="w-24 transition-all h-4/5 z-20 dark:border-themeBlue-9 border-r border-y rounded-r-xl bg-themeBlue-2 dark:bg-themeBlue-9 flex flex-col items-center justify-between p-2"
      >
        <div className="h-20 w-full flex font-Yellowtail items-center justify-center font-medium text-themeBlue-11 dark:text-themeBlue-2 prevent-select">
            ...
            <div className="size-10 flex items-center justify-center">
              <button
                ...
                className={clsx(
                  "size-9 hover:size-10 rounded-xl hover:rounded-lg cursor-pointer transition-all bg-themeBlue-11 hover:bg-themeBlue-6 text-themeBlue-2 dark:text-themeBlue-11 hover:dark:text-themeBlue-2 dark:hover:bg-themeBlue-6 dark:bg-themeBlue-2 flex items-center justify-center",
                  pause &&
                    "bg-themeBlue-6 dark:bg-themeBlue-6 dark:text-themeBlue-2 size-10 rounded-lg",
                  pulse && "animate-pulse"
                )}
              >
